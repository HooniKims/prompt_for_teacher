...
- 대화가 길어져도 입력창 아래의 **처음부터 다시 시작하기** 버튼으로 언제든 새 작업을 시작할 수 있습니다.

## 어떻게 쓰나요?

1. 처음 화면에 만들고 싶은 자료, 앱, 프로그램, 문서를 한두 문장으로 적습니다.
2. 이어지는 질문에 답하면서 수업 장면, 대상, 목표, 필요한 자료, 개인정보 처리 여부를 정리합니다.
3. 답변이 부족하면 더 자세히 묻고, 충분하면 최종 프롬프트를 만듭니다.
4. 오른쪽 완성본에서 `교사용 요약`, `AI 실행용 프롬프트`, `참고 안내`를 확인하고 필요한 부분을 복사합니다.
5. 다른 작업을 시작하려면 채팅 입력창 바로 아래의 **처음부터 다시 시작하기** 버튼을 누릅니다.
...
- 채팅 입력창 바로 아래에서 항상 보이는 처음부터 다시 시작하기
